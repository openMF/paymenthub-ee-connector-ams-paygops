# Contributing to paymenthub-ee-connector-ams-paygops

Thank you for your interest in contributing to the paymenthub-ee-connector-ams-paygops! We welcome contributions from the community to help improve financial inclusion solutions globally.
...
- Have a look at our [Wiki](https://github.com/openMF/paymenthub-ee-connector-ams-paygops/wiki).
...
- Fork the [project](https://github.com/openMF/paymenthub-ee-connector-ams-paygops) on GitHub
- Clone the project locally into your system.

```bash
git clone https://github.com/your-username/paymenthub-ee-connector-ams-paygops.git
```
...
```bash
git remote add upstream https://github.com/openMF/paymenthub-ee-connector-ams-paygops.git
```

2. Use `git remote -v` to check the status. The output must be something like this:

```bash
  > origin    https://github.com/your-username/paymenthub-ee-connector-ams-paygops.git (fetch)
  > origin    https://github.com/your-username/paymenthub-ee-connector-ams-paygops.git (push)
  > upstream  https://github.com/openMF/paymenthub-ee-connector-ams-paygops.git (fetch)
  > upstream  https://github.com/openMF/paymenthub-ee-connector-ams-paygops.git (push)
```
